...
- [ADR 0006 — Logging](../adr/0006-logging-centralized.md); централізовані логи доповнюють **Prometheus + Grafana** і **OpenTelemetry / Jaeger**.

---

[← Документація observability](README.md)
